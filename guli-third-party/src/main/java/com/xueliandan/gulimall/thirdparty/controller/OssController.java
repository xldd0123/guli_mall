package com.xueliandan.gulimall.thirdparty.controller;
...
/**
 * @author zxb 2025/8/16 23:14
 */
@RestController
@RequestMapping(path = "/third-party/oss")
...
//    String upload_dir = "dir";
    ...
    public static String generateExpiration(long seconds) {
        ...
        LOG.info("过期时间格式化后结果为: {}", formattedDate);
        // 输出结果
    ...
    public static AssumeRoleResponseBody.AssumeRoleResponseBodyCredentials getCredential() throws Exception {
        ...
        com.aliyun.sts20150401.models.AssumeRoleRequest assumeRoleRequest = new com.aliyun.sts20150401.models.AssumeRoleRequest()
                ...
                .setRoleSessionName("roleSession");// 自定义会话名称
    ...
    public ResponseEntity<Map<String, String>> getPostSignatureForOssUpload() throws Exception {
        ...
        String upload_dir = sdf.format(new Date()) + "/";

        String host = "https://edu-zxb-hangzhou.oss-cn-hangzhou.aliyuncs.com";
